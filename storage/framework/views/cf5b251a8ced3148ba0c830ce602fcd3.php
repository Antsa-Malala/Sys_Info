<<<<<<< Updated upstream:resources/views/pages/login.blade.php
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="super">
        ...
        <div class="bg-gradient">
            <img src="<?php echo e(URL::asset('/assets/img/logo-white.png')); ?>" alt="">
        </div>
    </div>
</body>
</html><?php /**PATH /home/sarobidy/Documents/GitHub/Sys_Info/resources/views/pages/login.blade.php ENDPATH**/ ?>
>>>>>>> Stashed changes:storage/framework/views/cf5b251a8ced3148ba0c830ce602fcd3.php
